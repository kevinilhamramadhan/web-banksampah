...
export default function InstallPengaturan() {
  ...
  return (
    <div className="card glass blob-container" style={{ position: "relative", zIndex: 1, overflow: "hidden", border: "1px solid var(--hijau)", padding: "20px" }}>
      <h2 className="gradient-text" style={{ fontSize: "1.2rem", fontWeight: 800 }}>Install Aplikasi</h2>
      ...
      {standalone ? (
        ...
        <>
          ...
          >
            <svg className="animate-float" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden style={{ animationDuration: "3s" }}>
